#!/usr/bin/env python3
# patch_649.py — Beta 0.649 / Phase 1.7: orderTypeOption migration

import shutil, sys

SRC  = "DepthVisionLab-v106_REAL_UI/public/index.html"
BACK = "DepthVisionLab-v106_REAL_UI/public/index-27.before_phase_0649_order_option_migration.html"
...
# ── 2. Insert DVL_BUTTON_DROPDOWN_OPTION_MIGRATION_CSS_0649 ──────────────────
html = rep(html,
    '.dvl-btn-migrated-panel {}\n</style>\n\n<style>\n:root{',
    '''.dvl-btn-migrated-panel {}
</style>

<style id="DVL_BUTTON_DROPDOWN_OPTION_MIGRATION_CSS_0649">
/* DVL Beta 0.649 — Phase 1.7: order type option migration pilot.
   Visual-neutral diagnostic class for migrated order type options.
...
<style>
:root{''',
    "insert DVL_BUTTON_DROPDOWN_OPTION_MIGRATION_CSS_0649")
...
html = rep(html,
    ...
    "version + changelog 0.649")

# ── 4. Replace entire DVL_BUTTON_SYSTEM_MODULE_0648 → 0649 ───────────────────
OLD_MODULE = '''// ===== DVL_BUTTON_SYSTEM_MODULE_0648 =====
(function(){
"use strict";
...
NEW_MODULE = '''// ===== DVL_BUTTON_SYSTEM_MODULE_0649 =====
(function(){
"use strict";
...
html = rep(html, OLD_MODULE, NEW_MODULE, "replace DVL_BUTTON_SYSTEM_MODULE_0648 → 0649")

# ── Write ─────────────────────────────────────────────────────────────────────
open(SRC, "w", encoding="utf-8").write(html)
print("[OK] patch_649 applied: title, DVL_APP_VERSION, badge, changelog 0.649, "
      "insert DVL_BUTTON_DROPDOWN_OPTION_MIGRATION_CSS_0649, replace module 0648→0649")

# ── Assertions ────────────────────────────────────────────────────────────────
content = open(SRC, encoding="utf-8").read()

# Version
assert '<title>DVL Binance Live — Beta 0.649</title>' in content,                   "FAIL: title 0.649"
assert 'const DVL_APP_VERSION = "Beta 0.649"' in content,                           "FAIL: DVL_APP_VERSION 0.649"
assert 'DVL_APP_VERSION).toUpperCase()' in content,                                 "FAIL: badge auto-update"
assert '"Beta 0.649 — Phase 1.7:' in content,                                       "FAIL: changelog 0.649 entry"
assert '"Beta 0.648", note: "Phase 1.6:' in content,                                "FAIL: changelog 0.648 preserved"

# CSS
assert 'id="DVL_BUTTON_DROPDOWN_OPTION_MIGRATION_CSS_0649"' in content,             "FAIL: dropdown option CSS id"
assert '.dvl-btn-migrated-order-option {}' in content,                              "FAIL: dvl-btn-migrated-order-option class"
...
# Module
assert '// ===== DVL_BUTTON_SYSTEM_MODULE_0649 =====' in content,                   "FAIL: module title 0649"
assert '// ===== DVL_BUTTON_SYSTEM_MODULE_0648 =====' not in content,               "FAIL: old module title still present"
assert "data-dvl-button-version', '0.649'" in content,                              "FAIL: data-dvl-button-version 0.649"
assert "data-dvl-button-version', '0.648'" not in content,                          "FAIL: old data-dvl-button-version still present"

# orderTypeOption migration
assert "el.classList.contains('orderTypeOption')" in content,                       "FAIL: orderTypeOption guard"
assert "el.classList.add('dvl-btn-migrated-order-option')" in content,              "FAIL: dvl-btn-migrated-order-option add"
assert 'function getMigratedOrderOptionButtons()' in content,                       "FAIL: getMigratedOrderOptionButtons function"
assert 'getMigratedOrderOptionButtons:  getMigratedOrderOptionButtons' in content,  "FAIL: getMigratedOrderOptionButtons export"

# audit() expansion
assert 'orderOptionTotal:' in content,                                              "FAIL: audit orderOptionTotal"
assert 'orderOptionMigrated:' in content,                                           "FAIL: audit orderOptionMigrated"
...
# No DVL_TODO_0649 remaining
assert 'DVL_TODO_0649' not in content,                                              "FAIL: DVL_TODO_0649 still present"
...
print("[OK] all 28 assertions passed — 0649 clean, orderTypeOption migrated, prior migrations preserved")
