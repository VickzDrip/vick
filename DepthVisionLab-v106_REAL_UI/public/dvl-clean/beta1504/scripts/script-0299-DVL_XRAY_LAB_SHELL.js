...
(function(){
  ...
  function ensureStyle(){
    ...
    s.textContent = [
      ...
      ".dvl-lab-bar{position:fixed;left:8px;right:8px;bottom:calc(env(safe-area-inset-bottom,0px) + 72px);z-index:2147483200;",
      " background:#08130d;border:1px solid #163a2b;border-radius:14px;padding:8px;display:none;",
      ...
      ".dvl-lab-sheet{position:fixed;left:0;right:0;bottom:0;z-index:2147483201;max-height:40vh;overflow:auto;",
      " background:#060f0b;border-top:1px solid #1c4634;border-radius:16px 16px 0 0;padding:12px 14px 18px;",
