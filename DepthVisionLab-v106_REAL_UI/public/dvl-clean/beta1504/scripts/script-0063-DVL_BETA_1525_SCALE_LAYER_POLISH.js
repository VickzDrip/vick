(function(){
  ...
  function flush(){
    ...
    divider.style.height = (canvas.clientHeight || 0) + "px";
    divider.style.background = "rgba(122,155,145,.18)";
    divider.style.boxShadow = "1px 0 0 rgba(0,0,0,.22)";
