#!/usr/bin/env python3
# patch_653.py — Beta 0.653 / Phase 1.11: paper confirm/edit button migration

import shutil, sys

SRC  = "DepthVisionLab-v106_REAL_UI/public/index.html"
BACK = "DepthVisionLab-v106_REAL_UI/public/index-17.before_0653_paper_confirm_migration.html"
...
# ── 2. Insert DVL_BUTTON_PAPER_CONFIRM_MIGRATION_CSS_0653 ─────────────────────
html = rep(html,
    '.dvl-btn-migrated-tools {}\n</style>\n\n<style>\n:root{',
    '''.dvl-btn-migrated-tools {}
</style>

<style id="DVL_BUTTON_PAPER_CONFIRM_MIGRATION_CSS_0653">
/* DVL Beta 0.653 — Phase 1.11: paper confirm/edit button migration pilot.
   Visual-neutral diagnostic classes for migrated paper buttons.
...
<style>
:root{''',
    "insert DVL_BUTTON_PAPER_CONFIRM_MIGRATION_CSS_0653")
...
html = rep(html,
    ...
    "version + changelog 0.653")

# ── 4. Replace entire DVL_BUTTON_SYSTEM_MODULE_0652 → 0653 ───────────────────
OLD_MODULE = '''// ===== DVL_BUTTON_SYSTEM_MODULE_0652 =====
(function(){
"use strict";
...
NEW_MODULE = '''// ===== DVL_BUTTON_SYSTEM_MODULE_0653 =====
(function(){
"use strict";
...
html = rep(html, OLD_MODULE, NEW_MODULE, "replace DVL_BUTTON_SYSTEM_MODULE_0652 → 0653")

# ── Write ─────────────────────────────────────────────────────────────────────
open(SRC, "w", encoding="utf-8").write(html)
print("[OK] patch_653 applied: title, DVL_APP_VERSION, badge, changelog 0.653, "
      "insert DVL_BUTTON_PAPER_CONFIRM_MIGRATION_CSS_0653, replace module 0652→0653")

# ── Assertions ────────────────────────────────────────────────────────────────
content = open(SRC, encoding="utf-8").read()

# Version
assert '<title>DVL Binance Live — Beta 0.653</title>' in content,                      "FAIL: title 0.653"
assert 'const DVL_APP_VERSION = "Beta 0.653"' in content,                              "FAIL: DVL_APP_VERSION 0.653"
assert 'DVL_APP_VERSION).toUpperCase()' in content,                                    "FAIL: badge auto-update"
assert '"Beta 0.653 — Phase 1.11:' in content,                                         "FAIL: changelog 0.653 entry"
assert '"Beta 0.652", note: "Phase 1.10:' in content,                                  "FAIL: changelog 0.652 preserved"

# CSS
assert 'id="DVL_BUTTON_PAPER_CONFIRM_MIGRATION_CSS_0653"' in content,                  "FAIL: paper confirm CSS id"
assert '.dvl-btn-migrated-paper-confirm {}' in content,                                "FAIL: dvl-btn-migrated-paper-confirm class"
assert '.dvl-btn-migrated-paper-edit {}' in content,                                   "FAIL: dvl-btn-migrated-paper-edit class"
...
# Module
assert '// ===== DVL_BUTTON_SYSTEM_MODULE_0653 =====' in content,                      "FAIL: module title 0653"
assert '// ===== DVL_BUTTON_SYSTEM_MODULE_0652 =====' not in content,                  "FAIL: old module title still present"
assert "data-dvl-button-version', '0.653'" in content,                                "FAIL: data-dvl-button-version 0.653"
assert "data-dvl-button-version', '0.652'" not in content,                            "FAIL: old data-dvl-button-version still present"

# Paper migration
assert "options.role === 'paper'" in content,                                           "FAIL: paper role check"
assert "el.closest('.dvl-paper-confirm')" in content,                                  "FAIL: dvl-paper-confirm closest guard"
assert "el.classList.add('dvl-btn-migrated-paper-confirm')" in content,                "FAIL: dvl-btn-migrated-paper-confirm add"
assert "el.closest('.dvl-paper-edit-confirm')" in content,                             "FAIL: dvl-paper-edit-confirm closest guard"
assert "el.classList.add('dvl-btn-migrated-paper-edit')" in content,                   "FAIL: dvl-btn-migrated-paper-edit add"
assert 'function getMigratedPaperConfirmButtons()' in content,                         "FAIL: getMigratedPaperConfirmButtons function"
assert 'function getMigratedPaperEditConfirmButtons()' in content,                     "FAIL: getMigratedPaperEditConfirmButtons function"
assert 'getMigratedPaperConfirmButtons:    getMigratedPaperConfirmButtons' in content, "FAIL: getMigratedPaperConfirmButtons export"
assert 'getMigratedPaperEditConfirmButtons: getMigratedPaperEditConfirmButtons' in content, "FAIL: getMigratedPaperEditConfirmButtons export"

# audit() expansion
assert 'paperConfirmTotal:' in content,                                                "FAIL: audit paperConfirmTotal"
assert 'paperConfirmMigrated:' in content,                                             "FAIL: audit paperConfirmMigrated"
assert 'paperEditConfirmTotal:' in content,                                            "FAIL: audit paperEditConfirmTotal"
assert 'paperEditConfirmMigrated:' in content,                                         "FAIL: audit paperEditConfirmMigrated"
...
# No DVL_TODO_0653 remaining
assert 'DVL_TODO_0653' not in content,                                                 "FAIL: DVL_TODO_0653 still present"
...
print("[OK] all 41 assertions passed — 0653 clean, paper confirm/edit migrated, prior migrations preserved")
