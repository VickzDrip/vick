#!/usr/bin/env python3
# patch_651.py — Beta 0.651 / Phase 1.9: asset/favorites/indicator dropdown migration

import shutil, sys

SRC  = "DepthVisionLab-v106_REAL_UI/public/index.html"
BACK = "DepthVisionLab-v106_REAL_UI/public/index-12.before_0651_asset_indicator_dropdown_migration.html"
...
# ── 2. Insert DVL_BUTTON_ASSET_INDICATOR_DROPDOWN_MIGRATION_CSS_0651 ──────────
html = rep(html,
    '.dvl-btn-migrated-keypad {}\n</style>\n\n<style>\n:root{',
    '''.dvl-btn-migrated-keypad {}
</style>

<style id="DVL_BUTTON_ASSET_INDICATOR_DROPDOWN_MIGRATION_CSS_0651">
/* DVL Beta 0.651 — Phase 1.9: asset/favorites/indicator dropdown migration pilot.
   Visual-neutral diagnostic classes for migrated dropdown buttons.
...
<style>
:root{''',
    "insert DVL_BUTTON_ASSET_INDICATOR_DROPDOWN_MIGRATION_CSS_0651")
...
html = rep(html,
    ...
    "version + changelog 0.651")

# ── 4. Replace entire DVL_BUTTON_SYSTEM_MODULE_0650 → 0651 ───────────────────
OLD_MODULE = '''// ===== DVL_BUTTON_SYSTEM_MODULE_0650 =====
(function(){
"use strict";
...
NEW_MODULE = '''// ===== DVL_BUTTON_SYSTEM_MODULE_0651 =====
(function(){
"use strict";
...
html = rep(html, OLD_MODULE, NEW_MODULE, "replace DVL_BUTTON_SYSTEM_MODULE_0650 → 0651")

# ── Write ─────────────────────────────────────────────────────────────────────
open(SRC, "w", encoding="utf-8").write(html)
print("[OK] patch_651 applied: title, DVL_APP_VERSION, badge, changelog 0.651, "
      "insert DVL_BUTTON_ASSET_INDICATOR_DROPDOWN_MIGRATION_CSS_0651, replace module 0650→0651")

# ── Assertions ────────────────────────────────────────────────────────────────
content = open(SRC, encoding="utf-8").read()

# Version
assert '<title>DVL Binance Live — Beta 0.651</title>' in content,                          "FAIL: title 0.651"
assert 'const DVL_APP_VERSION = "Beta 0.651"' in content,                                  "FAIL: DVL_APP_VERSION 0.651"
assert 'DVL_APP_VERSION).toUpperCase()' in content,                                        "FAIL: badge auto-update"
assert '"Beta 0.651 — Phase 1.9:' in content,                                              "FAIL: changelog 0.651 entry"
assert '"Beta 0.650", note: "Phase 1.8:' in content,                                       "FAIL: changelog 0.650 preserved"

# CSS
assert 'id="DVL_BUTTON_ASSET_INDICATOR_DROPDOWN_MIGRATION_CSS_0651"' in content,           "FAIL: asset/indicator CSS id"
assert '.dvl-btn-migrated-asset-favorite {}' in content,                                   "FAIL: dvl-btn-migrated-asset-favorite class"
assert '.dvl-btn-migrated-asset-dropdown {}' in content,                                   "FAIL: dvl-btn-migrated-asset-dropdown class"
assert '.dvl-btn-migrated-indicator-dropdown {}' in content,                               "FAIL: dvl-btn-migrated-indicator-dropdown class"
...
# Module
assert '// ===== DVL_BUTTON_SYSTEM_MODULE_0651 =====' in content,                          "FAIL: module title 0651"
assert '// ===== DVL_BUTTON_SYSTEM_MODULE_0650 =====' not in content,                      "FAIL: old module title still present"
assert "data-dvl-button-version', '0.651'" in content,                                    "FAIL: data-dvl-button-version 0.651"
assert "data-dvl-button-version', '0.650'" not in content,                                "FAIL: old data-dvl-button-version still present"

# Asset/favorites/indicator migration
assert "el.closest('.assetFavoritesSheet')" in content,                                    "FAIL: assetFavoritesSheet closest guard"
assert "el.classList.add('dvl-btn-migrated-asset-favorite')" in content,                   "FAIL: dvl-btn-migrated-asset-favorite add"
assert "el.closest('.assetDropdown')" in content,                                          "FAIL: assetDropdown closest guard"
assert "el.classList.add('dvl-btn-migrated-asset-dropdown')" in content,                   "FAIL: dvl-btn-migrated-asset-dropdown add"
assert "el.closest('.indicatorDropdown')" in content,                                      "FAIL: indicatorDropdown closest guard"
assert "el.classList.add('dvl-btn-migrated-indicator-dropdown')" in content,               "FAIL: dvl-btn-migrated-indicator-dropdown add"

# New helper functions
assert 'function getMigratedAssetFavoriteButtons()' in content,                            "FAIL: getMigratedAssetFavoriteButtons function"
assert 'function getMigratedAssetDropdownButtons()' in content,                            "FAIL: getMigratedAssetDropdownButtons function"
assert 'function getMigratedIndicatorDropdownButtons()' in content,                        "FAIL: getMigratedIndicatorDropdownButtons function"
assert 'getMigratedAssetFavoriteButtons:   getMigratedAssetFavoriteButtons' in content,    "FAIL: getMigratedAssetFavoriteButtons export"
assert 'getMigratedAssetDropdownButtons:   getMigratedAssetDropdownButtons' in content,    "FAIL: getMigratedAssetDropdownButtons export"
assert 'getMigratedIndicatorDropdownButtons: getMigratedIndicatorDropdownButtons' in content, "FAIL: getMigratedIndicatorDropdownButtons export"

# audit() expansion
assert 'assetFavoriteTotal:' in content,                                                   "FAIL: audit assetFavoriteTotal"
assert 'assetFavoriteMigrated:' in content,                                                "FAIL: audit assetFavoriteMigrated"
assert 'assetDropdownTotal:' in content,                                                   "FAIL: audit assetDropdownTotal"
assert 'assetDropdownMigrated:' in content,                                                "FAIL: audit assetDropdownMigrated"
assert 'indicatorDropdownTotal:' in content,                                               "FAIL: audit indicatorDropdownTotal"
assert 'indicatorDropdownMigrated:' in content,                                            "FAIL: audit indicatorDropdownMigrated"
...
# No DVL_TODO_0651 remaining
assert 'DVL_TODO_0651' not in content,                                                     "FAIL: DVL_TODO_0651 still present"
...
print("[OK] all 41 assertions passed — 0651 clean, asset/favorites/indicator dropdowns migrated, prior migrations preserved")
